        ...
        <div v-if="stepPage === 1" class="grid grid-cols-2 gap-x-8 gap-y-4">
          ...
          <div id="right" class="flex flex-col gap-y-4">
            ...
            <div id="description" class="flex flex-col gap-y-2">
              ...
              <textarea id="description" v-model="Ev_Description" placeholder="" class="resize-none h-36 rounded-md focus:outline-none py-1 px-2 shadow-md bg-gray-100" maxlength="599" />
